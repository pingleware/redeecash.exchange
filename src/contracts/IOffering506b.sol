...
abstract contract IOffering506b is BaseOffering {
    string public constant DESCRIPTION = string("Exempt Offering under Regulation D 506(b)");
    bool public constant RESTRICTED_SECURITY = true;
