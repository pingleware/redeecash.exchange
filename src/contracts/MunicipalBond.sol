...
/**
 * More about Municipal Bonds at https://www.sec.gov/munied
 */
...
contract MunicipalBond {
    ...
    IOfferingPool public poolAddress;
    ...
    function setOfferingPoolContract(address _poolContract) external {
        poolAddress = IOfferingPool(_poolContract);
    }
    ...
    function buy() external payable onlyRegisteredInvestors onlyAccreditedAndBrokerDealers notMatured {
    ...
    function addBondTrade(uint256 bondUnits, uint256 price) external onlyRegisteredInvestors onlyAccreditedAndBrokerDealers notMatured {
    ...
    function removeBondQuote() external onlyRegisteredInvestors onlyAccreditedAndBrokerDealers notMatured {
